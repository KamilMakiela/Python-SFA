...
data_path = os.path.join(my_dir, 'data', 'Produc.xlsx')
data = pd.read_excel(data_path, header=0, sheet_name='m1')
...
model  = sf_model.fit(X, y, my_n, T=my_T, sfa_opt=sf_op, dec_crit=1, if_mdd=1)
model.summary();
