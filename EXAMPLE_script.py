...
# We can choose one of the artificial datasets available for each model
# Description of the data generating process (DGP) is in the Excel file
# just uncomment the desired option
